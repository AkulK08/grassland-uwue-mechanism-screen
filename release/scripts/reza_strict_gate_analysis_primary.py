...
def analyze_one(path, version, n_boot, n_perm, min_obs, max_points):
    ...
    outdir = Path("results/reza_strict_boot100_primary")
...
def main():
    ...
    analyze_one("data/processed/reza_metric_matrix_raw.csv", "raw", args.n_boot, args.n_perm, args.min_obs, args.max_points)
    analyze_one("data/processed/reza_metric_matrix_co2corrected.csv", "co2corrected", args.n_boot, args.n_perm, args.min_obs, args.max_points)
