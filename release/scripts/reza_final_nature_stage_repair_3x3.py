...
OUT = Path("results/reza_final_nature_stage")
...
PAIRS = [
    ("data/processed/reza_metric_matrix_raw.csv", STAGE / "reza_metric_matrix_raw_FINAL3x3.csv"),
    ("data/processed/reza_metric_matrix_co2corrected.csv", STAGE / "reza_metric_matrix_co2corrected_FINAL3x3.csv"),
]
...
def find_best_qa_match(matrix_df, qa):
    ...
    if score == 0:
        ...
        raise SystemExit("Could not match AppEEARS QA to metric matrix. See results/reza_final_nature_stage/modis_qa_match_attempts.csv and modis_qa_no_match_diagnostics.json")
