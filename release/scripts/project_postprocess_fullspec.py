...
OUT = Path("results/project_fullspec")
...
def manifest():
    required = [
        ...
        "results/project_fullspec/fullspec_aridity_summary_raw.csv",
        "results/project_fullspec/fullspec_aridity_summary_co2corrected.csv",
        ...
        "results/project_fullspec/qc_audit_raw.json",
        "results/project_fullspec/qc_audit_co2corrected.json",
    ]
    rows = []
    for f in required:
        p = Path(f)
