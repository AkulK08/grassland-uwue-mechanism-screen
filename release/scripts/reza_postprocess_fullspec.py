...
OUT = Path("results/reza_fullspec")
...
def manifest():
    required = [
        ...
        "results/reza_fullspec/fullspec_aridity_summary_raw.csv",
        "results/reza_fullspec/fullspec_aridity_summary_co2corrected.csv",
        ...
        "results/reza_fullspec/qc_audit_raw.json",
        "results/reza_fullspec/qc_audit_co2corrected.json",
    ]
    rows = []
    for f in required:
        p = Path(f)
