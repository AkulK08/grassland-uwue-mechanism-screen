...
def analyze(path, version, args):
    ...
    outdir = Path("results/reza_fullspec")
...
def main():
    ...
    args = ap.parse_args()
    analyze("data/processed/reza_metric_matrix_raw.csv", "raw", args)
    analyze("data/processed/reza_metric_matrix_co2corrected.csv", "co2corrected", args)
