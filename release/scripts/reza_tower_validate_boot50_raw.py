...
OUT = Path("results/reza_tower_validation_boot50_raw")
OUT.mkdir(parents=True, exist_ok=True)

SAT_RESULTS = Path("results/reza_final_nature_boot50/fullspec_response_results_raw.csv")
SAT_MATRIX = Path("data/processed/final_nature/reza_metric_matrix_raw_FINAL3x3.csv")
