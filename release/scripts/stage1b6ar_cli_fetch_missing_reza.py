...
ROOT = Path.cwd()
OUT = ROOT / "results/stage1b6ar_cli_fetch_missing_reza"
TAB = OUT / "tables"
TXT = OUT / "text"
DISC = ROOT / "data/raw/towers/_reza_raw_exports/cli_download_discovery"
DEST = ROOT / "data/raw/towers/_reza_raw_exports/manual_fluxnet"
...
(TAB / "STAGE1B6AR_CLI_FETCH_MISSING_REZA_DECISION.json").write_text(json.dumps(decision, indent=2), encoding="utf-8")

report = []
report.append("# Stage 1B.6AR CLI fetch missing Reza data")
report.append("")
...
report.append("```")
(TXT / "STAGE1B6AR_CLI_FETCH_MISSING_REZA_REPORT.md").write_text("\n".join(report), encoding="utf-8")
