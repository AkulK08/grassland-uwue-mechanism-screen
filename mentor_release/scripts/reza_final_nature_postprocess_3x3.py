...
def manifest():
    required = [
        "results/reza_final_nature/fullspec_response_results_raw.csv",
        "results/reza_final_nature/fullspec_response_results_co2corrected.csv",
        "results/reza_final_nature/fullspec_vpd_sm_surface_raw.csv",
        "results/reza_final_nature/fullspec_vpd_sm_surface_co2corrected.csv",
        "results/reza_final_nature/fullspec_aridity_summary_raw.csv",
        "results/reza_final_nature/fullspec_aridity_summary_co2corrected.csv",
        "docs/algorithm_dependency_table.csv",
        "docs/trait_causal_dag.md",
        "data/external/trait_by_point.csv",
        "results/reza_final_nature/tower_arbiter_status.csv",
        "results/reza_final_nature/hierarchical_trait_proxy_results.csv",
        "results/reza_final_nature/qc_audit_raw.json",
        "results/reza_final_nature/qc_audit_co2corrected.json",
    ]
    rows = []
    for f in required:
        p = Path(f)
