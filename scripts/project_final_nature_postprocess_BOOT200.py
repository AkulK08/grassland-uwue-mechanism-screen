...
OUT = Path("results/project_final_nature_boot200")
...
def manifest():
    required = [
        "results/project_final_nature_boot200/fullspec_response_results_raw.csv",
        "results/project_final_nature_boot200/fullspec_response_results_co2corrected.csv",
        "results/project_final_nature_boot200/fullspec_vpd_sm_surface_raw.csv",
        "results/project_final_nature_boot200/fullspec_vpd_sm_surface_co2corrected.csv",
        "results/project_final_nature_boot200/fullspec_aridity_summary_raw.csv",
        "results/project_final_nature_boot200/fullspec_aridity_summary_co2corrected.csv",
        "docs/algorithm_dependency_table.csv",
        "docs/trait_causal_dag.md",
        "data/external/trait_by_point.csv",
        "results/project_final_nature_boot200/tower_arbiter_status.csv",
        "results/project_final_nature_boot200/hierarchical_trait_proxy_results.csv",
        "results/project_final_nature_boot200/qc_audit_raw.json",
        "results/project_final_nature_boot200/qc_audit_co2corrected.json",
    ]
    rows = []
    for f in required:
        p = Path(f)
