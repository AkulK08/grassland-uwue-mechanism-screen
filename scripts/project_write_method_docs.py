...
Path("results/project_strict").mkdir(exist_ok=True, parents=True)

Path("docs/project_method_patch_notes.md").write_text("""# project feedback method patch notes

This repo patch addresses the reviewer feedback by changing the analysis target from a raw WUE threshold on a collapsed one-dimensional compound-stress index to a stricter, pre-specified framework.
...
files = {
    "strict_raw": "results/project_strict/strict_response_results_raw.csv",
    "strict_co2": "results/project_strict/strict_response_results_co2corrected.csv",
    "surface_raw": "results/project_strict/vpd_sm_surface_partial_effects_raw.csv",
    "surface_co2": "results/project_strict/vpd_sm_surface_partial_effects_co2corrected.csv",
    "qa_wide": "data/processed/modis_qa_by_point_8day_wide.csv",
    "metric_raw": "data/processed/project_metric_matrix_raw.csv",
    "metric_co2": "data/processed/project_metric_matrix_co2corrected.csv",
...
Path("results/project_strict/project_patch_manifest.json").write_text(json.dumps(manifest, indent=2))
