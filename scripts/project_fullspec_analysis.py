...
def analyze(path, version, args):
    ...
    outdir = Path("results/project_fullspec")
...
def main():
    ...
    args = ap.parse_args()
    analyze("data/processed/project_metric_matrix_raw.csv", "raw", args)
    analyze("data/processed/project_metric_matrix_co2corrected.csv", "co2corrected", args)
