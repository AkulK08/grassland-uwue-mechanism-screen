...
mkdir -p logs results/project_strict data/processed

echo "============================================================"
echo "project STRICT SMOKE TEST"
echo "Started: $(date)"
echo "============================================================"
...
ls -lh \
  ...
  scripts/project_strict_gate_analysis.py
...
ls -lh \
  ...
  data/processed/project_metric_matrix_raw.csv \
  data/processed/project_metric_matrix_co2corrected.csv
...
df = pd.read_csv("data/processed/project_metric_matrix_raw.csv", nrows=1000)
needed = [
    "modis_gpp_qc_good",
    "modis_et_qc_good",
...
python scripts/project_strict_gate_analysis.py \
  --n-boot 10 \
  --n-perm 9 \
  --min-obs 50 \
  --max-points 5
...
for p in [
    "results/project_strict/strict_response_results_raw.csv",
    "results/project_strict/strict_response_results_co2corrected.csv",
    "results/project_strict/vpd_sm_surface_partial_effects_raw.csv",
    "results/project_strict/vpd_sm_surface_partial_effects_co2corrected.csv",
]:
    print("\n====", p, "====")
...
echo "============================================================"
echo "project STRICT SMOKE TEST FINISHED"
echo "Finished: $(date)"
echo "============================================================"
