...
def main():
    ...
    build_one_matrix(Path(args.raw), Path("data/processed/reza_metric_matrix_raw.csv"), qa_wide, soil_csv)
    build_one_matrix(Path(args.co2), Path("data/processed/reza_metric_matrix_co2corrected.csv"), qa_wide, soil_csv)
