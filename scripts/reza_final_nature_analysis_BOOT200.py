...
def analyze(path, version, args):
    ...
    outdir = Path("results/reza_final_nature_boot200")
...
def main():
    ...
    args = ap.parse_args()
    analyze("data/processed/final_nature/reza_metric_matrix_raw_FINAL3x3.csv", "raw", args)
    analyze("data/processed/final_nature/reza_metric_matrix_co2corrected_FINAL3x3.csv", "co2corrected", args)
