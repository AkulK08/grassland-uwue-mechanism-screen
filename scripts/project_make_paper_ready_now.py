...
TOWER_VERDICT = Path("results/project_tower_validation_boot50_raw/README_tower_validation_verdict.md")
...
summary.append("")
summary.append("- The reviewer-level trait thesis is not unlocked until tower-centered MODIS/PML/ERA5 extraction completes.")
...
summary.append("- Do not claim the reviewer-level causal trait result until the tower-centered matrix and trait model are complete.")
summary.append("")
...
verdict = {
    ...
    "reviewer_trait_thesis_unlocked": False,
