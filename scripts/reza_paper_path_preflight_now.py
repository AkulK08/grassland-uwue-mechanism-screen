...
# ----------------------------
add("")
add("## 4. Overall mentor-paper path verdict")
...
add("The paper path is computationally alive, but the mentor-level thesis is not unlocked until tower-centered MODIS/PML/ERA5 extraction completes and identifies a credible satellite product/metric family. Do not waste time rerunning global products. The next decisive bottleneck is the tower-centered GEE export now pending.")
